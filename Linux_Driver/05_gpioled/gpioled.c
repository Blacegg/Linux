...
ssize_t gpioled_read(struct file *filp, char __user *buf, size_t cnt, loff_t *offt)
{
	return 0;
}

ssize_t gpioled_write(struct file *filp, const char __user *buf, size_t cnt, loff_t *offt)
{
	int retvalue;
